...
- it exposes local module metadata and doctor checks for future adapters

It does not implement ENS, 0G, KeeperHub, signer, webhook, OS notification, browser UI, hosted service, or demo integration behavior.
