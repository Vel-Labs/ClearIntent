# ClearIntent Technical README

This file preserves the earlier root README as a technical repo-orientation reference. The canonical submission/product entrypoint is the root `README.md`.
